...
class AnalogGaugeWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.font = QFont(self.default_font, 20)
        ...
        self.scale_fontname = self.default_font
        ...
        self.value_fontname = self.default_font
    ...
    # Scale Marker
    ###############################################################################################
    def draw_scale_bg(self):
        my_painter = QPainter(self)
        my_painter.setRenderHint(QPainter.Antialiasing)
        bgpix = QImage(self.background)
        my_painter.begin(bgpix)
        my_painter.drawImage(0, 0, bgpix)
        # my_painter.end()
